...
{
    class UnknownUnitViewModel : DesignerItemViewModelBase
    {
        ...
        public UnknownUnitViewModel(int id, DiagramViewModel parent, double left, double top)
           : base(id, parent, left, top)
        {
            init();
        }
        public UnknownUnitViewModel(int id, DiagramViewModel parent, double left, double top, double itemWidth, double itemHeight)
    : base(id, parent, left, top, itemWidth, itemHeight)
        {
            init();
        }
        public UnknownUnitViewModel()
         : base()
        {
            init();
        }
